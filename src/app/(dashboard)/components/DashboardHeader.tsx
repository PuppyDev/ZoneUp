import ButtonAI from "./Button/ButtonAI";
import ButtonActionNew from "./Button/ButtonActionNew";
import ButtonQuickActionMenu from "./Button/ButtonQuickActionMenu";
import ButtonUserMenu from "./Button/ButtonUserMenu";
    ...
    return (
        ...
        >
            <div className="flex items-center w-full text-xs">
                ...
                <div className="mr-8 space-x-2 grow text-end md:flex md:items-center md:justify-center">
                ...
                <div className="inline-flex items-center gap-3">
                    <Button
                        ...
                        style={{
                            background: "linear-gradient(-45deg,#ffc800,#ff02f0,#8930fd,#49ccf9)",
                        }}
                    >
